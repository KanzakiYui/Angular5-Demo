...
module.exports = "<div id=\"useraccountCollectionMain\">\n\t<div class=\"card\">\n  \t\t<div class=\"card-header\">\n\t\t\t<div>\n\t\t\t\t<i class=\"fas fa-heart\"></i>\n\t\t\t</div>\n\t\t\t<div>\n\t\t\t\tCollection Repository\n\t\t\t</div>\n\t\t\t<div>\n\t\t\t\t<i class=\"fas fa-heart\"></i>\n\t\t\t</div>\t\t\n\t\t</div>\n  \t\t<div class=\"card-body\">\n\t\t\t<div class=\"useraccountCollectionContainer\">\n\t\t\t\t<ng-scrollbar #scrollRef>\n\t\t\t\t\t<figure class=\"useraccountCollectionItem\" *ngFor=\"let item of collectionList\">\n\t\t\t\t\t\t<h4>Favorite {{item.name}}</h4>\n\t\t\t\t\t\t<div>\n\t\t\t\t\t\t\t<img src={{item.url}}>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"blur\" (mouseenter)=\"itemHovered($event)\" (mouseleave)=\"itemHover($event)\" (click)=\"itemClicked($event)\">\n\t\t\t\t\t\t\tClick to view detail\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</figure>\n\t\t\t\t</ng-scrollbar>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>"
...
var UsercollectionComponent = /** @class */ (function () {
    function UsercollectionComponent() {
        this.collectionList = [
            { name: "Smartphone", url: "assets/img/collect01.png" },
            { name: "Album", url: "assets/img/collect02.png" },
            { name: "Disc", url: "assets/img/collect03.png" },
            { name: "Laptop", url: "assets/img/collect04.png" },
            { name: "Headphone", url: "assets/img/collect05.png" },
            { name: "Keyboard", url: "assets/img/collect06.png" },
            { name: "Desklamp", url: "assets/img/collect07.png" },
            { name: "Camera", url: "assets/img/collect08.png" },
            { name: "Watch", url: "assets/img/collect09.png" },
            { name: "Sunglass", url: "assets/img/collect10.png" },
        ];
    }
